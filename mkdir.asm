...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    106b:	48 b8 be 14 00 00 00 	movabs $0x14be,%rax
    1072:	00 00 00 
    1075:	ff d0                	call   *%rax
    ...
    1095:	48 b8 37 1e 00 00 00 	movabs $0x1e37,%rax
    109c:	00 00 00 
...
printf(int fd, char *fmt, ...)
{
  ...
  for (i = 0; (c = fmt[i] & 0xff) != 0; i++) {
    ...
    1865:	00 
    1866:	48 b8 60 1e 00 00 00 	movabs $0x1e60,%rax
    186d:	00 00 00 
    ...
    1a44:	75 41                	jne    1a87 <printf+0x36e>
        s = "(null)";
    1a46:	48 b8 58 1e 00 00 00 	movabs $0x1e58,%rax
    1a4d:	00 00 00 
